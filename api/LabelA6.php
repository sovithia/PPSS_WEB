...
function renderFourProduct($products)
{
  ...
  $render = 
    "
    <div class='A4_portrait' id='A4_Image'>  
    <center>
    <table>
    <tr>
      <td>
...
function _renderFreeProduct($product)
{
  if ($product == null)
    return "";
  ...
  return "<div class='A4_A6'>
      ...
      <div class='A6_body'>
        <div class='sale_img'>
            ...
            <div class='A6_sale'>
              <p style='font-size: 15px; margin-top: -50px; font-family: kh;'>ទិញ១ ថែម១</p>
              <p style='font-size: 15px; margin-top: -15px; font-family:'acumin';'>BUY 1 FREE1</p>
            </div>
          </div>
      </div>
      <div class='A6_bottom'>
          ...
          <div class='A6_box-price'>
            <div class='A6_box-price1'>
              <div class='A6_box-price2'>
                <div class='A6_priceriel'>
                  <p>$rielPrice</p>
                </div>
                <div class='A6_symboolreil'>
                  <p>៛</p>
                </div>
              </div>
              <div class='A6-box-flag'>
                <div class='A6-flag'>
                  <img src='$flag'>
                </div>
                <div class='A6-unit'>
              ...
              <div class='A6_priceen'>
                <div class='A6_symboolen'>
                  <p>$</p>
                </div>
                <div class='A6_priceen1'>
                  <p>$dollarPrice</p>
                </div>
              </div>
            </div>
  ...
  return "
    <div class='A4_A6'>
      ...
      <div class='A6_bottom'>
        ...
        <div class='A6_box2'>
          <div class='box-img'>
            <div class='A6_percent'>
              <div class='A6_box_percent'>
                <div class='A6_percent_disc'>
                  <p>$percent</p>
                </div>
                  <div class='A6_percent_disc1'>
                    <div class='A6_off'>
                      <p>OFF</p>
                    </div>
                    <div class='A6_percent1'>
                        <p>%</p>
                    </div>
                  </div>
              </div>
